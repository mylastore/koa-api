...
var _deserializeUser = _interopRequireDefault(require("./middleware/deserializeUser"));
...
app.use((0, _koaHelmet["default"])()); // Log successful interactions
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            console.info(ctx.method + ' ' + ctx.url + ' RESPONSE: ' + ctx.response.status);
            _context.next = 8;
            break;
...
app.use( /*#__PURE__*/function () {
  var _responseTime = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(ctx, next) {
    var t1, t2;
...
app.use(_deserializeUser["default"]); //For cors with options
